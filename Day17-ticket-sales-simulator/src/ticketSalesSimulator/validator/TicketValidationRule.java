...
public enum TicketValidationRule {
    ...
    SALE_STATUS_NOT_NULL(TicketErrorCode.SALE_STATUS_NULL),
    SEAT_COUNT_EXCEEDS_LIMIT(TicketErrorCode.SEAT_COUNT_EXCEEDS_LIMIT),

    QUANTITY_POSITIVE(TicketErrorCode.QUANTITY_NOT_POSITIVE),
    BUYER_NAME_NOT_EMPTY(TicketErrorCode.BUYER_NAME_EMPTY),
    ORDER_STATUS_NOT_NULL(TicketErrorCode.ORDER_STATUS_NULL),
